document.addEventListener("DOMContentLoaded", () => {
    ...
    const gbcData = [
        ...
        },
        {
            ...
            devs: "Luiz Antônio, Júlia Leandro",
        ...
        },
        {
            ...
            devs: "Ricardo Vitor  Guilherme Afonso, Thiago Fraportti, Guilherme Medeiros, Guilherme Souto",
        ...
        },
        {
            ...
            devs: "João Victor Batista, Esdras Rodrigues, Dave, Gabriel",
        ...
        },
        {
            ...
            devs: "João Victor Batista, Maria Laura Floresta, Laura Veloso, Felipe Freire",
        ...
        },
        {
            ...
            devs: "Daniel Alburquerque, Jorge Gabriel, Stephanie Tavares, Ygor Salsa",
    ...
    async function carregarInstagramDinamico() {
        ...
        if (!INSTA_API_URL || INSTA_API_URL.trim() === "") {
            ...
            renderizarFeedInsta([
                ...
                {
                    id: "demo2",
                    mediaUrl: "https://images.unsplash.com/photo-1592478411213-6153e4ebc07d?auto=format&fit=crop&q=80&w=600",
